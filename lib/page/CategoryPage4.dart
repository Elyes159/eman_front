...
class CategoryPage4 extends StatelessWidget {
  final List<Map<String, dynamic>> categories = [
    ...
    {'title': 'Bureautiques', 'imagePath': 'assets/images/bureau2.png'},
...
class _GridBState extends State<GridB> {
  ...
  Widget build(BuildContext context) {
    final List<Map<String, dynamic>> gridMap = [
      {
        "price": "TND1.5",
        "title": "TUBE DE 80 EPINGLE TABLEAU LIEGE DELI",
        "imagePath": "assets/images/tub.jpg",
        "discount": "-60%",
      },
      {
        "title": "Chemise 3 Rabats OfficePlast à Elastique",
        "price": "TND1.9",
        "imagePath": "assets/images/chemise.jpg",
        "discount": "-49%",
      },
      {
        "title": "Pochette Géometrique Aladin 15 CM 3 Piéces",
        "price": "TND2.4",
