...
class CategoryPage5 extends StatelessWidget {
  ...
  final List<Map<String, dynamic>> categories = [
    ...
    {'title': 'Infomatique', 'imagePath': 'assets/images/info2.png'},
...
class _GridBState extends State<GridB> {
  ...
  Widget build(BuildContext context) {
    final List<Map<String, dynamic>> gridMap = [
      {
        "price": "TND659",
        "title": "PC Portable LENOVO IdeapPad 3 AMD Athlon 8Go 1To+256Go SSD",
        "imagePath": "assets/images/img2.jpg",
        "discount": "-60%",
      },
      {
        "title": "PC DE BUREAU I3 10EME 8G 256G SSD",
        "price": "TND939",
        "imagePath": "assets/images/unite.jpg",
        "discount": "-38%",
      },
      {
        "title": "HIKVISION WEBCAM DS-U12 FULL HD 1080P",
        "price": "TND99",
        "imagePath": "assets/images/cam.jpg",
        "discount": "-48%",
      },
