...
class CustomAppBarPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Material(
      child: Scaffold(
        backgroundColor:
            Color(0xFFFFFFFF), // Définir la couleur de fond en blanc
...
class AuthProvider extends ChangeNotifier {
  bool _isLoggedIn = false; // Définissez une valeur par défaut pour _isLoggedIn
  ...
  void login() {
    setLoggedIn(
        true); // Utilisez la méthode setLoggedIn pour mettre à jour _isLoggedIn
  }

  void logout() {
    setLoggedIn(
        false); // Utilisez la méthode setLoggedIn pour mettre à jour _isLoggedIn
  }
}
...
class _SignFormState extends State<SignForm> {
  ...
  TextFormField buildEmailFormField(TextEditingController controller) {
    return TextFormField(
      ...
      controller: controller, // Assign the initialized controller
