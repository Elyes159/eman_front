...
class _GridBState extends State<GridB> {
  ...
  Widget build(BuildContext context) {
    final List<Map<String, dynamic>> gridMap = [
      {
        "price": "TND219",
        "title": "Hachoir à Viande Touch Avec Accessoires 2000W - Noir",
        "imagePath": "assets/images/ramadhan1.jpg",
        "discount": "-24%",
      },
      {
        "title": "KARCHER NETTOYEUR HAUTE PRESSION K2 COMPACT",
        "price": "TND289",
        "imagePath": "assets/images/net.jpg",
        "discount": "-11%",
      },
      {
        "title": "TORNADO CLIMATISEUR 18000 BTU FR",
        "price": "TND1499",
        "imagePath": "assets/images/clim.jpg",
        "discount": "-24%",
      },
      {
        "title": "WHIRLPOOL PLAQUE CHAUFFANTE 4 Feux 60 CM INOX",
        "price": "TND499",
